...
To test this out I generated entropy values for the finals games between Reynor and Zest, R04 games
between Reynor and Maru and RO8 games between TY and PartinG and checked the values to see if
they made any sort of sense.
