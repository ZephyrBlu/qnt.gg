...
think are more important such as initial and later game tech choices had much higher entropies than
generic production buildings.

An interesting unexpected result that I didn't think about was that Terran add-ons are counted as
their own building as a unique building + add-on pair (E.g. StarportReactor). Since these combinations
are relatively rare compared to other buildings they also have quite high entropy, which makes
sense when you think about it because add-on choice is actually quite important and
